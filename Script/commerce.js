...
if ($request.url.indexOf(path1) != -1)
{
    ...
    //修改
    //var res = JSON.parse(ddgksf2013.response)
    //res.flag = true;
           
    //ddgksf2013.response=JSON.stringify(res);
    //替换失败，可能是正则表达式的问题
    var res = ddgksf2013.response.replace(/flag\\":false/,"flag\":true");
    ddgksf2013.response = res;
